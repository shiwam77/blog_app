...
*/
                        ...
                        child: Row(
                          children: [
                            getCurrentItem().url != null
                                ...
                                : Container(),
                            getCurrentItem().url != null
                                ? Icon(MdiIcons.arrowRightBoldBoxOutline)
                                : Container(),
                            getCurrentItem().url != null
                                ? Text(
                        ...
                        child: VisibilityDetector(
                          ...
                          child: GestureDetector(
                            ...
                            onTap: () {
                              setState(() {
                                if (isVolume == false) {
                                  speak(getCurrentItem().trimedDescription);
  ...
  void getBlogVotes() async {
    print(
        "getBlogVotes currentUser.value.id ${currentUser.value.id} ${languageCode}");
